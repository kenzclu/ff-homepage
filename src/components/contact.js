    ...
    return (
      <React.Fragment>
        <form
          ...
          method="POST"
        >
          <Typography>Feel free to email me at kenlu.me08@gmail.com</Typography>
          <br></br>
        ...
        <Snackbar open={this.state.sending} autohideduration={5000}>
        ...
        >
          {this.state.error ? (
            ...
            <Alert severity="success" autohideduration={5000}>
